        ...
        <div className="flex items-center justify-between flex-wrap gap-6 mb-12 animate-astral-nav">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="relative" ref={presetsRef}>
              ...
              {showPresets && (
                <div className="absolute right-0 mt-3 w-64 bg-[var(--t-surface)] border border-[var(--t-border-subtle)] rounded-2xl shadow-2xl z-[200] overflow-hidden backdrop-blur-3xl animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200">
