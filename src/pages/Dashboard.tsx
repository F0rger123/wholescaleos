  ...
  return (
    <DashboardErrorBoundary>
      <div className="space-y-8 p-6 lg:p-12 min-h-screen bg-[var(--t-bg)] text-[var(--t-text)]">
        {/* Header */}
        <div className="flex items-center justify-between flex-wrap gap-6 mb-12 animate-astral-nav relative z-[50]">
          <div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="relative" ref={presetsRef}>
              ...
              {showPresets && (
                <div className="absolute right-0 mt-3 w-64 bg-[var(--t-surface)] border border-[var(--t-border-subtle)] rounded-2xl shadow-2xl z-[400] overflow-hidden backdrop-blur-3xl animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200">
