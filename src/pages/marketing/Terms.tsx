    ...
    <div className="bg-[#0f172a] min-h-screen text-white pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-400">
          <p className="text-xl text-gray-300">Last Updated: March 25, 2024</p>
          
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-white">1. Acceptance of Terms</h2>
            <p>
              By accessing or using WholeScale OS, you agree to be bound by these Terms of Service. 
          ...
          <section className="space-y-4">
            ...
            <p>
              WholeScale OS provides a platform for real estate professionals to manage leads, 
              automate communications, and organize their business operations.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              You agree not to use our services for any unlawful purpose or in any way that violates 
              these Terms. This includes, but is not limited to, sending spam or unauthorized marketing.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              All content and materials available on WholeScale OS are the property of WholeScale OS 
          ...
          <section className="space-y-4">
            ...
            <p>
              WholeScale OS shall not be liable for any indirect, incidental, special, consequential, 
