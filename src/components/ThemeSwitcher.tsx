...
export function ThemeSwitcher() {
  ...
  return (
    <div className="relative">
      ...
      {/* Theme Picker Modal - Using a simple modal approach */}
      {isOpen && (
        <div 
          ref={dialogRef}
          className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-96 max-h-[80vh] overflow-hidden rounded-xl border shadow-2xl"
          style={{
            backgroundColor: 'var(--t-surface)',
