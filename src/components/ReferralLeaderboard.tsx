    ...
    <div className="p-8 rounded-[3rem] bg-[#121a2d] border border-white/5 relative overflow-hidden shadow-2xl">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h3 className="text-xl font-bold italic text-white">Elite Affiliates</h3>
            <p className="text-[10px] text-indigo-500 font-bold uppercase tracking-widest">Global Top 10 Leaderboard</p>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-0.5">
                    <span className="text-[9px] text-[#6d758c] font-bold uppercase">{leader.referralCount} Refs</span>
        ...
        {leaders.length === 0 && (
          <div className="text-center p-8 text-sm text-[#6d758c] italic border border-dashed border-white/5 rounded-2xl">
            Initialing leaderboard data...
          </div>
        )}
      </div>
    </div>
